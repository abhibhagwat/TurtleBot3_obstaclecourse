...
echo_and_run cd "/home/abhibhagwat/catkin_auefinals/src/auefinals/spawn_robot_tools/spawn_robot_tools_pkg"
...
echo_and_run /usr/bin/env \
    ...
    "/home/abhibhagwat/catkin_auefinals/src/auefinals/spawn_robot_tools/spawn_robot_tools_pkg/setup.py" \
     \
    build --build-base "/home/abhibhagwat/catkin_auefinals/build/auefinals/spawn_robot_tools/spawn_robot_tools_pkg" \
    install \
    --root="${DESTDIR-/}" \
