...
echo_and_run cd "/home/abhibhagwat/catkin_auefinals/src/auefinals/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/home/abhibhagwat/catkin_auefinals/src/auefinals/vision_opencv/cv_bridge/setup.py" \
     \
    build --build-base "/home/abhibhagwat/catkin_auefinals/build/auefinals/vision_opencv/cv_bridge" \
    install \
    --root="${DESTDIR-/}" \
